module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('user-create-error', _error.bind(this))
			//when it is successfull
			.once('user-create-success', _success.bind(this))
	...
	var _success = function(result) {
		...
		this.controller.unlisten('user-create-error');
	...
	var _error = function(error) {
		...
		this.controller.unlisten('user-create-success');
		//trigger that a response has been made
		this.controller.trigger('user-action-response', this.request, this.response);
	};
