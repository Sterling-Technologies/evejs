module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('file-restore-error', function(error) {
				//setup an error response
