module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('post-join-error', _error.bind(this))
			//when it is successfull
			.once('post-join-success', _success.bind(this))
			//Now call to remove the post
			.trigger('post-join', this.controller, collection, query);
	};
	...
	var _success = function() {
		...
		this.controller.unlisten('post-join-error');
	...
	var _error = function(error) {
		...
		this.controller.unlisten('post-join-success');
		//trigger that a response has been made
		this.controller.trigger('post-action-response', this.request, this.response);
	};
