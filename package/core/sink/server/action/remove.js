module.exports = require('edenjs').extend(function() {
	...
	this.response = function() {
		...
		this._controller
			...
			.once('sink-remove-error', this._error.bind(this.capture()))
			//when it is successfull
			.once('sink-remove-success', this._success.bind(this.capture()))
			//Now call to remove the sample
			.trigger('sink-remove', this._request.variables[0]);
	};
