module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('address-remove-error', _error.bind(this))
			//when it is successfull
			.once('address-remove-success', _success.bind(this))
			//Now call to remove the address
			.trigger('address-remove', this.controller, this.request.variables[0]);
	};
    ...
    var _success = function(row) {
		...
		this.controller.unlisten('address-remove-error');
	...
	var _error = function(error) {
		...
		this.controller.unlisten('address-remove-success');
		//trigger that a response has been made
		this.controller.trigger('address-action-response', this.request, this.response);
	};
