module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('post-comment-restore-error', function(error) {
				//setup an error response
			...
			.once('post-comment-restore-success', function() {
			...
			.trigger('post-comment-restore', self.controller, self.request.variables[0]);
	}
