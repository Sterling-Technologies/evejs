module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('postuser-create-error', _error.bind(this))
			//when it is successfull
			.once('postuser-create-success', _success.bind(this))
			//Now call to remove the user
			.trigger('postuser-create', this.controller, query);
	};
    ...
    var _success = function() {
		...
		this.controller.unlisten('postuser-create-error');
	...
	var _error = function(error) {
		...
		this.controller.unlisten('postuser-create-success');
		//trigger that a response has been made
		this.controller.trigger('postuser-action-response', this.request, this.response);
	};
