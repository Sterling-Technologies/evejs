module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('user-remove-error', _error.bind(this))
			//when it is successfull
			.once('user-remove-success', _success.bind(this))
	...
	var _success = function(row) {
		...
		this.controller.unlisten('user-remove-error');
	...
	var _error = function(error) {
		...
		this.controller.unlisten('user-remove-success');
		//trigger that a response has been made
		this.controller.trigger('user-action-response', this.request, this.response);
	};
