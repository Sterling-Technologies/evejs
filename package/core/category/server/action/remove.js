module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('category-remove-error', function(error) {
				//setup an error response
