module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('post-remove-error', _error.bind(this))
			//when it is successfull
			.once('post-remove-success', _success.bind(this))
	...
	var _success = function(row) {
		...
		this.controller.unlisten('post-remove-error');
	...
	var _error = function(error) {
		...
		this.controller.unlisten('post-remove-success');
		//trigger that a response has been made
		this.controller.trigger('post-action-response', this.request, this.response);
	};
