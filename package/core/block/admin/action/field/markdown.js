define(function() {
	return jQuery.eve.base.extend(function() {
		...
		-------------------------------*/
        this._data 		= {};
        this._template 	= '/field/textarea.html';
		...
		this.loadAssets = function() {
			...
			$('<link rel="stylesheet" type="text/css" />')
				.attr('href', this.Controller().path('block/asset') + '/styles/markdown.css')
				.appendTo('head');
			
			//add script to header
			//<script type="text/javascript" src="/scripts/markdown.js">script>
			$('<script type="text/javascript"></script>')
				.attr('src', this.Controller().path('block/asset') + '/scripts/markdown.js')
				.appendTo('head');
