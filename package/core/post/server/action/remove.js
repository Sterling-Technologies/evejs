module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('post-remove-error', function(error) {
				//setup an error response
