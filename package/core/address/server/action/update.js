module.exports = (function() {
	...
	public.render = function() {
		...
		this.controller
			...
			.once('address-update-error', _error.bind(this))
			//when it is successfull
			.once('address-update-success', _success.bind(this))
			//Now call to update the user
			.trigger('address-update', this.controller, this.request.variables[0], query);
	};
    ...
    var _error = function(error) {
		...
		this.controller.unlisten('address-update-success');
	...
	var _success = function() {
		...
		this.controller.unlisten('address-update-error');
		//trigger that a response has been made
		this.controller.trigger('address-action-response', this.request, this.response);
	};
