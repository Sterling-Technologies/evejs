module.exports = function($) {
	return this.define(function(public) {
		...
		var _stream = function(request) { 
			return function(onStart, onData, onEnd) {
				//use formidable
				var query = [], form = new _formidable.IncomingForm();
				
				//onPart will always be called before parse
				form.onPart = function (part) {
					...
					onStart(part.filename, part.mime);
					
					//when data chunks are received
					part.addListener('data', onData);
				};
