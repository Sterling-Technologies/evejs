module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('post-restore-error', _error.bind(this))
			//when it is successfull
			.once('post-restore-success', _success.bind(this))
	...
	var _success = function(row) {
		...
		this.controller.unlisten('post-restore-error');
	...
	var _error = function(error) {
		...
		this.controller.unlisten('post-restore-success');
		//trigger that a response has been made
		this.controller.trigger('post-action-response', this.request, this.response);
	};
