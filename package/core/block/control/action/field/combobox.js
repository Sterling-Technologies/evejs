define(function() {
    ...
    public.template = controller.path('block/template') + '/field/combobox.html';
		...
		require([controller.path('block/action') + '/field/autocomplete.js'], function(action) {
			...
			action.load().loadAssets(function() {
				...
				$('<script type="text/javascript"></script>')
					.attr('src', controller.path('block/asset') + '/scripts/combobox.js')
					.appendTo('head');
    ...
    var _output = function(next) {
		...
		this.data.attributes, 'class', 'eve-field-combobox form-control');
