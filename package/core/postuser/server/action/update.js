module.exports = (function() {
	...
	public.render = function() {
		...
		this.controller
			...
			.once('postuser-update-error', _error.bind(this))
			//when it is successfull
			.once('postuser-update-success', _success.bind(this))
			//Now call to update the postuser
			.trigger('postuser-update', this.controller, this.request.variables[0], query);
	};
    ...
    var _error = function(error) {
		...
		this.controller.unlisten('postuser-update-success');
	...
	var _success = function() {
		...
		this.controller.unlisten('postuser-update-error');
		//trigger that a response has been made
		this.controller.trigger('postuser-action-response', this.request, this.response);
	};
