module.exports = (function() {
	...
	public.render = function() {
		...
		this.controller
			...
			.once('user-update-error', _error.bind(this))
			//when it is successfull
			.once('user-update-success', _success.bind(this))
	...
	var _error = function(error) {
		...
		this.controller.unlisten('user-update-success');
	...
	var _success = function() {
		...
		this.controller.unlisten('user-update-error');
		//trigger that a response has been made
		this.controller.trigger('user-action-response', this.request, this.response);
	};
