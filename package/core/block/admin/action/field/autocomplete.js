define(function() {
	return jQuery.eve.base.extend(function() {
		...
		-------------------------------*/
        this._data 		= {};
		this._template 	= '/field/autocomplete.html';
		...
		this.loadAssets = function() {
			...
			$('<link rel="stylesheet" type="text/css" />')
				.attr('href', this.Controller().path('block/asset') + '/styles/autocomplete.css')
				.appendTo('head');
			
			//add script to header
			//<script type="text/javascript" src="/scripts/autocomplete.js">script>
			$('<script type="text/javascript"></script>')
				.attr('src', this.Controller().path('block/asset') + '/scripts/autocomplete.js')
				.appendTo('head');
		...
		this.response = function(request) {
			...
			this._data.attributes, 'class', 'eve-field-autocomplete');
